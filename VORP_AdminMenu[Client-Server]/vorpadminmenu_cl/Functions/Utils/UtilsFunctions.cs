...
namespace vorpadminmenu_cl.Functions.Utils
{
    class UtilsFunctions : BaseScript
    {
        ...
        public static async Task<List<object>> GetThreeByNUI(List<object> args, string label, string hint, string label2, string hint2,string label3, string hint3)
        {
            string V1 = null;
            string V2 = null;
            string V3 = null;
            ...
            TriggerEvent("vorpinputs:getInput", label3, hint3, new Action<dynamic>((value3) =>
            {
                V3 = value3;
                args.Add(V3);
            }));
